...
set08_min$age <- scale(as.numeric(set08_min$age))
set08_min$edu <- scale(as.numeric(set08_min$edu))
set08_min$hh_inc <- scale(as.numeric(set08_min$hh_inc))
set08_min$lsm <- scale(as.numeric(set08_min$lsm))
...
set08_min$sex <- factor(set08_min$sex,
                        levels = c(1,2),
                        labels = c("male", "female"))
set08_min$race <- factor(set08_min$race,
                         levels = c(1,2,3,4),
                         labels = c("black", "coloured", "indian", "white"))
set08_min$lifestages <- factor(set08_min$lifestages,
...
set08_min$mar_status <- factor(set08_min$mar_status,
                               levels = c(1,2,3,4,5),
                               labels = c("single", "married or living together", "widowed", "divorced", "separated"))
set08_min$lifestyle <- factor(set08_min$lifestyle,
...
set08_min$attitudes <- factor(set08_min$attitudes,
...
try <- predict(fact_08, data = set08_min[,7:ncol(set08_min)])

# save model
saveRDS(fact_08, "fact_08.rds")
# getS3method("predict", "prcomp")
# getS3method("print", "princomp")
